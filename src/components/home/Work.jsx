          ...
          >
            <div className="mockup-container reverse exclusive">
              ...
              >
                ...
                <p className="info">
                  A sophisticated project built with React js on the frontend and Node js on the backend.
                  Firebase is used to store audio and photos, and MongoDB is utilized to store JSON
                  information files about users and beats. Adding beats is done through the admin panel, which
                  is separate from the main site. Basically, the admin panel is used to maintain the site. The
                  main functionality of the site are transactions, which is why someone would want to visit
                  it. To purchase high-quality beats on a modern design!
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <div className="mockup-container">
              ...
              >
                ...
                <p className="info">
                  Instagram Clone built with HTML, CSS, Javascript (JQuery), PHP and MYSQL for a student
                  project. Because there is no follow functionality every post is global. Which means that
                  every user can see each others posts and comments. (maybe a new social media? :) ) Basicaly
                  every CRUD operation is used in some way throughout the site.
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <div className="mockup-container reverse">
              ...
              >
                ...
                <p className="info">
                  Another student project, this time created with HTML, CSS, and Vanilla Javascript. A simple
                  memory card game that everyone is familiar with, but with three unique variations. There are
                  three levels of difficulty: easy, medium, and hard. The size of the table and the tiles
                  within them are the key differences between them. Easy is 4x4, medium is 6x6, and hard is
                  8x8. You can aim for a high score while running away from the timer using a scoreboard that
                  resets after the session (limitations of the student project).
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            <div className="mockup-container">
              ...
              >
                ...
                <p className="info">
                  Student project made using JQuery, PHP and MYSQL. As a user you are able to add posts, add
                  comments, view other profiles and save posts. Despite having a similar project Instagram
                  Clone this one has a better code, because this time wasn't my first time making a PHP
                  website.
                </p>
              </motion.div>
            </div>
          ...
          >
            <div className="mockup-container reverse">
              ...
              >
                ...
                <p className="info">
                  What more to say? Netflix clone made using React js. The main goal wasn't a functionality
                  but a basic idea of learning to create a Netflix style interface. Watching videos isn't
                  available because... 🏴‍☠️. But looking through what is new and popular definetely is. Using
                  Movie Database for fetching information makes the site all the time relevant considering the
          ...
          >
            <div className="mockup-container">
              ...
              <motion.div className="info-container">
                ...
                <p className="info">
                  A basic weather app that is made to work only on mobile phones, using React Native. With
                  basic animations, the design is modern and simple. Current weather and temperature, both
                  hourly and daily, are available as a option to check. Based on the preferences or your the
                  system you use to check the temperature, it is also avaliable to change from kelvin to
                  fehrenheit and kelvins. Data is being updated hourly by using OpenWeather API.
                </p>
              </motion.div>
            </div>
          </motion.div>
